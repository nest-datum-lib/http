...
export class SettingService extends Mixin(ModelService, ModelTokenService, ModelEnvService, ModelUserService, ModelDataTypeService, ModelDataValueService, ModelRemovableTokenService, ModelDatesService) {
}
